...
public class AssignTaskDialog extends javax.swing.JDialog {
    ...
    public AssignTaskDialog(java.awt.Frame parent, boolean modal) {
        ...
        // Configure rating spinner: 0 means "not selected yet"; valid range is 1–10
        rating.setModel(new javax.swing.SpinnerNumberModel(0, 0, 10, 1));
        rating.setToolTipText("Select weekly rating (1–10)");
    }
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(rating, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap())))))
        );
    ...
    private void remarksBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_remarksBtnActionPerformed
        ...
        int r;
        try {
            Object v = rating.getValue();
            r = (v instanceof Number) ? ((Number) v).intValue() : Integer.parseInt(String.valueOf(v).trim());
        } catch (Exception ex) {
            r = -1;
        }
        if (r < 1 || r > 10) {
            javax.swing.JOptionPane.showMessageDialog(
                    this,
                    "Please select a rating from 1 to 10 before submitting.",
                    "Rating Required",
    ...
    public Integer getSelectedRating0to10() {
        try {
            Object v = rating.getValue();
            int r = (v instanceof Number) ? ((Number) v).intValue() : Integer.parseInt(String.valueOf(v).trim());
    ...
    public void loadExistingData(AdminModel model) {
        ...
        int existingRating = AdminModel.getWeeklyRating(key);
        ...
        // Prefill rating if available
        if (existingRating >= 1 && existingRating <= 10) {
            rating.setValue(existingRating);
        } else {
            rating.setValue(0); // not selected
        }
    }
